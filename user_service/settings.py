...
INSTALLED_APPS = [
    ...
    'user_service_api.apps.UserServiceApiConfig',
    'rest_framework',
    'social_django',
...
SOCIAL_AUTH_GOOGLE_OAUTH2_REDIRECT_URI = 'http://localhost:8000/user/api/v1/google/social/auth/complete/google-oauth2/'
